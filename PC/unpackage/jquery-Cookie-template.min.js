...
/* include */
(function(d,e){function f(){}f.prototype={forEach:function(a,b){for(var c=a.length-1;0<=c;c--)b.apply(a[c],[c])},c:function(){var a=d.document.location.href,b=d.document.location.pathname;return a.substring(0,a.indexOf(b))+b.substring(0,b.substr(1).lastIndexOf("/")+1)},b:function(a){var b=0<navigator.userAgent.indexOf("MSIE")?new ActiveXObject("Microsoft.XMLHTTP"):new XMLHttpRequest;b.open("get",a,!1);b.send(null);return b.responseText},i:function(a){var b=e.createElement("div");b.innerHTML=a;return b.childNodes},
a:function(a){for(var b=/<script>([\s\S]*?)<\/script>/g,c;c=b.exec(a);)eval(c[1])},f:function(a){a.replace(/<script>([\s\S]*?)<\/script>/g,"");return a},g:function(a){for(var b=/\.\.\//g,c=0;b.exec(a);)c++;return c},h:function(a,b){if(/http:\/\//g.test(b))return b;for(var c=this.g(b);c--;)a=a.substring(0,a.substr(1).lastIndexOf("/")+1);return a+"/"+b.replace(/\.\.\//g,"")},j:function(){var a=this,b=a.c();this.forEach(e.getElementsByTagName("include"),function(){var c=this.getAttribute("src");c=a.b(a.h(b,
c));for(var g=this.parentNode,h=a.i(a.f(c)),l=h.length,k=0;k<l;k++)g.insertBefore(h[0],this);a.a(c);g.removeChild(this)})}};d.onload=function(){(new f).j()}})(window,document);